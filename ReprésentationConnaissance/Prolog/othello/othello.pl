...
menuPrincipal:-
	...
	tab(6),writeln('2 - Humain vs Machine'),
...
% Usage : saisieNomJoueur2 enregistre le nom du joueur 2
saisieNomJoueur:-
	writeln('Entrez le nom du Joueur  (sans oublier le point) : '),
	read(J),
	retractall(nomJoueur(_X)),
	asserta(nomJoueur(J)),!.
...
%%% choix de lancer le jeu humain contre Machine
lanceChoix(2):-
    % recupere le nom des joueurs et l ajoute dans la BF
	saisieNomJoueur1,
	% affiche la grille de depart
